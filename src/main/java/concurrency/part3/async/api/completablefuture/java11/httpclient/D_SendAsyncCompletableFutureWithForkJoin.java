...
public class D_SendAsyncCompletableFutureWithForkJoin {

	public static void main(String[] args) {

		var client = HttpClient.newHttpClient();
		var request = HttpRequest.newBuilder().uri(URI.create("http://sahet.net"))
				.build();
		 ...
		 * 
		 * - It uses by default ForkJoin pool (ideally: # threads = # of cores)
		 */
