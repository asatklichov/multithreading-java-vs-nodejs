...
public class D_CompletableFutureCombiningFuture_thenCompose_thenCompbine_thenAcceptBoth_acceptEither {
	public static void main(String[] args) throws InterruptedException, ExecutionException { 
		 ...
		 */
		//thenCombine can combine two different return types
		CompletableFuture<String> completableFuturez = CompletableFuture.supplyAsync(() -> "Hello(T1)")
				.thenCombine(CompletableFuture.supplyAsync(() -> " World(T2)".length()), (s1, s2) -> s1 + " Beautiful " + s2);

		System.out.println("Hello(T1) Beautiful 10".equalsIgnoreCase(completableFuturez.get()));
		 ...
		 */
		//thenAcceptBoth can accept two different return types
		CompletableFuture<Void> thenAcceptBoth = CompletableFuture.supplyAsync(() -> "Hello".length()).thenAcceptBoth(
		...
		// acceptEither - must be two SAME return types		
		/**
		...
		//(Integer)"1".length() Type mismatch: cannot convert from CompletableFuture<Integer> to CompletableFuture<String>
		...
		System.out.println("Hello World".equalsIgnoreCase(completableFuturez.get()));
